...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { aquired_at: @weather.aquired_at, date: @weather.date, rainfall: @weather.rainfall, temp_feel: @weather.temp_feel, temp_max: @weather.temp_max, temp_min: @weather.temp_min, weather_id: @weather.weather_id } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { aquired_at: @weather.aquired_at, date: @weather.date, rainfall: @weather.rainfall, temp_feel: @weather.temp_feel, temp_max: @weather.temp_max, temp_min: @weather.temp_min, weather_id: @weather.weather_id } }
